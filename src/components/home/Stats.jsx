...
export default function Stats() {
  ...
  return (
    <section className="relative overflow-hidden bg-ink-950 py-20 md:py-24" aria-label={t('stats.title')}>
      <div
        aria-hidden
        className="absolute -right-32 -top-32 h-96 w-96 rounded-full bg-[radial-gradient(closest-side,rgb(11_143_74/0.22),transparent)]"
      />
      <div
        aria-hidden
        className="absolute -bottom-40 -left-24 h-96 w-96 rounded-full bg-[radial-gradient(closest-side,rgb(217_165_0/0.15),transparent)]"
      />
